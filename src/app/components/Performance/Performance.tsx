...
const Performance = () => {
  ...
  return (
    <div className="  md:w-[63%]  h-fit xl:h-[638px] xl:block flex p-0 xl:p-6 xl:items-start flex-col items-center justify-center xl:justify-normal rounded-lg bg-white ">
      <div
        id="overview"
